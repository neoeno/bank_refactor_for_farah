...
CSVFormatter.prototype.formatStatement = function (statement) {
...
CSVFormatter.prototype._formatTransaction = function (transaction) {
...
CSVFormatter.prototype._formatDeposit = function (amount, balance) {
  let arr = [];
...
CSVFormatter.prototype._formatWithdraw = function (amount, balance) {
  let arr = [];
...
CSVFormatter.prototype._formatAmountToDecimal = function (num) {
  let decimaledAmount = (parseFloat(Math.round(num * 100) / 100).toFixed(2));
  return decimaledAmount;
};

CSVFormatter.prototype._formatDate = function () {
  let date = new Date();
